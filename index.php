...
<header class="text-center" name="home">
  <div class="intro-text">
    <h1>Photography helps people to see.</h1>
    <p>- Berenice Abbott</p>
    <div class="clearfix"></div>
    <a href="#works-section" class="btn btn-default btn-lg page-scroll">Visit Us</a> </div>
</header>
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/08.jpg" rel="prettyPhoto">
              <div class="hover-text">
                <h4>Marine Drive</h4>
                <small>Puri-Konark</small>
                <div class="clearfix"></div>
              </div>
              <img src="img/portfolio/08.jpg" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <a href="port.php" class="btn btn-default btn-lg page-scroll" style="">More</a>
      </div>
    </div>
  </div>
</div>
